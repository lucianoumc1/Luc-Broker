...
function showComingSoonMessage() {
    ...
    if (!comingSoonSection) {
        ...
        comingSoonSection.className = 'bg-white rounded-lg shadow-sm border border-secondary-200 compact-padding fade-in';
        iframeContainer.appendChild(comingSoonSection);
    }
    ...
    comingSoonSection.innerHTML = `
        <div class="text-center py-8">
            ...
            <h3 class="text-xl font-bold text-secondary-900 mb-3">Próximamente...</h3>
            <p class="text-secondary-600">Estamos trabajando para ofrecerte la mejor cotización de seguros para automóviles. ¡Muy pronto estará disponible!</p>
        </div>
    `;
}
